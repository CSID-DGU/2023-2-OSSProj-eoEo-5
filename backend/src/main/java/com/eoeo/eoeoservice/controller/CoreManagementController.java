...
public class CoreManagementController {
    ...
    public Long addSchool(@RequestParam AddSchoolRequestDto request){
        System.out.println(request.getSchoolName());
        return coreManagementService.addSchool(request);
    }

    @PostMapping("/addcorelecturetype")
    public Long addCoreLectureType(@RequestParam AddCoreLectureTypeRequestDto request){
